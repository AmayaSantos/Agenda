package besysoft.agendaApp.controller.handler;
...
public class RestFullExceptionHandler {
	...
	public ProcessMensage handleMissingServletRequestParameter(
			MissingServletRequestParameterException ex, HttpHeaders headers, HttpStatus status, HttpServletRequest req) {

		String error = ex.getParameterName() + " parametro es requerido";
	...
	public ProcessMensage handleInesperadas(Throwable ex, HttpServletRequest req) {
		...
		String error = "Error realizando operacion - " + req.toString();
